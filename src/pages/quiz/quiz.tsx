...
export const Quiz = () => {
  ...
  const { fetchedData, fetching, questionNum, selected, finished } = useSelector(quizSelector);
  ...
  const questionRender = () => {
    ...
    return <InfoQuestion title={question.label} description={question.description} />;
  };
  ...
  return (
    <>
      {finished ? (
        ...
        <>
          <QuizHeader quizLength={fetchedData.length} questionNumber={questionNum} />
          <Indicator />
